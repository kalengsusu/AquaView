                ...
                <div class="p-5 bg-light rounded-3 border col-xl-6">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control @error('firstName') is-invalid @enderror" type="text" name="firstName" id="firstName" value="{{ old('firstName') }}" placeholder="Masukkan Nama">
                            @error('firstName')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control @error('lastName') is-invalid @enderror" type="date" name="lastName" id="lastName" value="{{ old('lastName') }}" placeholder="">
                                @error('lastName')
                            <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="age" class="form-label">Jumlah</label>
                            <input class="form-control @error('age') is-invalid @enderror" type="text" name="age" id="age" value="{{ old('age') }}" placeholder="Masukkan Jumlah">
                                @error('age')
                            <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <label for="position" class="form-label">Destinasi</label>
